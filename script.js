...
form.addEventListener("submit", (event) => {
  ...
  // para nao carregar a pagina quando clicar no botao
...
function setErrorFor(input, message) {
  const formControl = input.parentElement; // vai retornar a div com o pai dele que é o form-control
  const small = formControl.querySelector("small");

  // add msg de erro
  small.innerText = message;
  // add a classe do erro
